<script lang="ts" module>
	/**
	 * Lightweight inline icon set (Lucide-style line icons).
	 *
	 * Replaces emoji across the site with consistent stroke icons that match
	 * the SVGs already used in the navbar/footer — no external dependency.
	 * Paths are static, trusted strings (no user input), rendered via {@html}.
	 */
	...
	const ICONS: Record<IconName, string> = {
		...
		newspaper:
			'<path d="M15 18h-5"/><path d="M18 14h-8"/><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2"/><path d="M10 6h8v4h-8z"/>'
	};
...
<script lang="ts">
	...
	let { name, size = 24, stroke = 2, class: klass = '' }: Props = $props();
